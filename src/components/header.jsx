        ...
        <div>
            <div className="  h-screen w-full bg-gradient-to-b from-[#8B0000] via-[#3b0000] via-30% to-[#350505] ">
                <div className=" flex md:flex md:flex-row md:justify-between w-full text-center md:text-left justify-unset flex-col">
                    <div>
                        <h1 className="tracking-[1px] lg:tracking-[3px] font-small text-[25px] lg:text-[45px] text-[rgb(228_219_219)] lg:text-[rgb(206_199_199)] pt-[12px] lg:pt-[13px] pr-0  pl-0  md:pl-[30px] animate-forfade 48px serif text-center  md:text-left">Crafted for </h1>
                        <h1 class="tracking-[2px] font-medium text-[35px] lg:text-[70px] text-[#D4AF37] pl-0  md:pl-[25px] animate-womenfade text-center md:text-left">THE WOMAN </h1>
                        <h1 className="tracking-[1px] lg:tracking-[3px] font-medium text-[25px] lg:text-[34px] text-[rgb(228_219_219)] lg:text-[rgba(255_255_255_.92)] pt-[12px] lg:pt-0 pr-0 lg:pb-[5px] pl-0  md:pl-[30px] animate-forfade 48px serif text-center  md:text-left">who wears confidence</h1>
